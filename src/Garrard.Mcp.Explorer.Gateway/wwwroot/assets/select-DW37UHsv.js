...
`,classes:{root:`p-iconfield`}}),provide:function(){return{$pcIconField:this,$parentInstance:this}}},inheritAttrs:!1};function Pe(e,t,n,r,i,a){return w(),M(`div`,N({class:e.cx(`root`)},e.ptmi(`root`)),[T(e.$slots,`default`)],16)}K.render=Pe;var q={name:`InputIcon`,extends:{name:`BaseInputIcon`,extends:F,style:z.extend({name:`inputicon`,classes:{root:`p-inputicon`}}),props:{class:null},provide:function(){return{$pcInputIcon:this,$parentInstance:this}}},inheritAttrs:!1,computed:{containerClass:function(){return[this.cx(`root`),this.class]}}};function Fe(e,t,n,r,i,a){return w(),M(`span`,N({class:a.containerClass},e.ptmi(`root`),{"aria-hidden":`true`}),[T(e.$slots,`default`)],16)}q.render=Fe;var Ie=z.extend({name:`virtualscroller`,css:`
.p-virtualscroller {
    position: relative;
    overflow: auto;
    contain: strict;
