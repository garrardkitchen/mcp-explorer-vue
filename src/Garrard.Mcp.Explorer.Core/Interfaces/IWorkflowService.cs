...
public interface IWorkflowService
{
    ...
    Task<LoadTestResult> RunLoadTestAsync(string workflowId, string connectionName, int durationSeconds, int maxParallelExecutions, Dictionary<string, string>? runtimeParameters = null, CancellationToken cancellationToken = default);
