...
public sealed class HttpRunbookCommand : AsyncCommand<HttpRunbookCommand.Settings>
{
    private readonly HttpRunbookParser _parser = new();
    private readonly HttpRunbookExecutor _executor;
